...
local _M = {
    name = STRINGS.TACTICALBREACHWIZARDS.ABILITIES.FALSEPROPHET,
...
function _M:createToolTip(sim, unit, targetCell)
    return abilityutil.formatToolTip(
        STRINGS.TACTICALBREACHWIZARDS.ABILITIES.FALSEPROPHET,
        STRINGS.TACTICALBREACHWIZARDS.ABILITIES.FALSEPROPHET_DESC,
        1
    )
end
