...
local _M = {
    name = STRINGS.TACTICALBREACHWIZARDS.ABILITIES.CHAINBOLT_AIM,
...
function _M:createToolTip(sim, unit, targetCell)
    return abilityutil.formatToolTip(
        STRINGS.TACTICALBREACHWIZARDS.ABILITIES.CHAINBOLT_AIM,
        STRINGS.TACTICALBREACHWIZARDS.ABILITIES.CHAINBOLT_AIM_DESC,
        1
    )
end
