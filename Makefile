...
files := modinfo.txt scripts.zip gui.kwad anims.kwad sound.kwad
...
rar: build
	mkdir -p out/TacticalBreachWizards
	cp modinfo.txt out/TacticalBreachWizards/
	cp out/scripts.zip out/TacticalBreachWizards/
	cp out/gui.kwad out/TacticalBreachWizards/
	cp out/anims.kwad out/TacticalBreachWizards/
	cd out && rar a ../TacticalBreachWizards\ V.0.3.rar \
		TacticalBreachWizards/modinfo.txt \
		TacticalBreachWizards/scripts.zip \
		TacticalBreachWizards/gui.kwad \
		TacticalBreachWizards/anims.kwad
...
out/gui.kwad out/anims.kwad out/sound.kwad: $(anims) $(guis) $(sounds)
	mkdir -p out
